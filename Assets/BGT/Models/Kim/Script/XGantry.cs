...
public class XGantry : MonoBehaviour
{
    ...
    private float[] moveDistancesRight = { -0.529f, -1.484753f+0.721753f, -0.263f + 0.038f, -1.185f + 0.018f ,0f}; // 오른쪽 Y8
    // 왼쪽 이동 (Y축 양수 방향)을 위한 이동 거리들 (예: 0.75f면 현재 위치에서 +0.75만큼 이동)
    private float[] moveDistancesLeft = { 1.135f, 1.409f, 0.2f + 0.12f + 1.031f, 0f }; // 왼쪽 Y9
